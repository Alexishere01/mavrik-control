...
osascript -e "tell application \"Terminal\" to do script \"cd '$DIR' && source venv/bin/activate && clear && echo 'Starting Ardupilot SITL with JSON backend...' && sim_vehicle.py -v ArduPlane -f quadplane --model JSON:127.0.0.1 --add-param-file=mavrik.parm --out udpin:127.0.0.1:14552 --wipe-eeprom --map --console\""
